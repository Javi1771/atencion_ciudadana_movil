...
class _IncidenceFormScreenState extends State<IncidenceFormScreen>
  ...
  Future<void> _submit() async {
    ...
    //? 2) Guarda localmente en SQLite
    await IncidenceLocalRepo.save(data);

    //? 3) Si quieres notificar al usuario sobre la sincronización:
    ...
    //? 4) Simulación de envío o lógica adicional
                  ...
                  children: [
                    Expanded(
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color:
                              isActive ? theme.primaryColor : Colors.grey[300],
        ...
        child: ClipRRect(
          ...
          child: Column(
            children: [
              ...
              //* Contenido del paso con espacio para el botón
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(20),
                  child: Column(
                    children: [
                      //* Contenido del paso con desplazamiento
                      Expanded(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.credit_card, color: Color(0xFF6D1F70)),
            suffixIcon:
                _curpCtrl.text.isNotEmpty
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: Color(0xFF6D1F70), width: 2),
            ),
            filled: true,
  ...
  Widget _buildStep3Content() {
    return Step3Form(
      ...
      onTipoSolicitanteChanged:
          (value) => setState(() => _tipoSolicitante = value),
      origen: _origen,
        ...
        if (_currentStep > 0)
          Expanded(
            ...
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.arrow_back, color: Color(0xFF6D1F70)),
              label: const Text(
                'Anterior',
